...
func _on_store_changed(name, state):
	if store.get_state() != null and store.get_state()['canvas']['dimensions'] != null:
		print('Canvas Dimensions changed to : ' + str(store.get_state()['canvas']['dimensions']))
